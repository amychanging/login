...
define(function(require,exports){
	...
	var tpl = '<div class="'+ className +'" style="width:100%;overflow:hidden;line-height:2;font-size: 14px;background:#78222c;text-align:center;color:#fff;height:28px;">test</div>';
	var el;
